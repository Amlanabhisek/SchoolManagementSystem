...
class teacherClass:
    def __init__(self,root):
        ...
        self.root.geometry("1500x620+10+140")
        self.root.resizable(False,False)
        self.root.config(bg='white')
        # self.root.iconbitmap('image/music.ico')
        self.root.grab_set()
        ...
        search_btn = Button(saerch_frame,text='Search',cursor="hand2",bd=3,bg='springgreen3',font=("times new roman",20,"bold"),command=self.search)
        ...
        save_btn =Button(self.root,text='Save',cursor="hand2",bd=3,bg='dodgerblue',font=("times new roman",20,"bold"),activeforeground="red",command=self.save)
        save_btn.place(x=90,y=490,height=40,width=120)

        delete_btn =Button(self.root,text='Delete',cursor="hand2",bd=3,bg='red1',font=("times new roman",20,"bold"),activeforeground="red",command=self.delete)
        delete_btn.place(x=260,y=490,height=40,width=120)

        update_btn =Button(self.root,text='Update',cursor="hand2",bd=3,bg='springgreen3',font=("times new roman",20,"bold"),activeforeground="red",command=self.update)
        update_btn.place(x=430,y=490,height=40,width=120)

        save_btn =Button(self.root,text='Export',cursor="hand2",bd=3,bg='turquoise2',font=("times new roman",20,"bold"),activeforeground="red",command=self.exportdata)
        save_btn.place(x=600,y=490,height=40,width=120)

        save_btn =Button(self.root,text='Show All',cursor="hand2",bd=3,bg='palegreen2',font=("times new roman",20,"bold"),activeforeground="red",command=self.show)
        save_btn.place(x=260,y=550,height=40,width=120)

        clear_btn =Button(self.root,text='Clear',cursor="hand2",bd=3,bg='SlateGray2',font=("times new roman",20,"bold"),activeforeground="red",command=self.clear)
